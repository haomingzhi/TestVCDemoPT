...
#import "JYCourseViewController.h"
#import "JYCourseViewModel.h"
#import "CustomRefreshGifHeader.h"
#import "DDExNoDataView.h"
#import "JYClassInfoTableViewCell.h"


@interface JYCourseViewController()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@property(nonatomic,strong)JYCourseViewModel *viewModel;

@end

@implementation JYCourseViewController
    -(void)viewDidLoad
{
    [super viewDidLoad];
