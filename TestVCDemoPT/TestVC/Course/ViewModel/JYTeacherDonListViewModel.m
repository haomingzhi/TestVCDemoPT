//
    //  TeacherDonListViewController.m
    //  Model
    //
...
#import "JYTeacherDonListViewModel.h"
#import "DDRequestManager.h"

@interface JYTeacherDonListViewModel()
@property(nonatomic,strong)JYBaseViewModel *obj;
@end
@implementation JYTeacherDonListViewModel
-(void)fetchDataDetail:(NSDictionary *)parms Completion:(void (^)(BOOL success, NSString *message))block
{
    __weak typeof(self) weak_self = self;
    Class c = [[DDRequestManager sharedManager] getClass:@"TeacherDonList"];
