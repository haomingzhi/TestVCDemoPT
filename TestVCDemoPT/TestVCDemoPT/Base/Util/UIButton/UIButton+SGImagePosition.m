...
- (void)SG_imagePositionStyle:(SGImagePositionStyle)imagePositionStyle spacing:(CGFloat)spacing {
    if (imagePositionStyle == SGImagePositionStyleDefault) {
        ...
        [self setImageEdgeInsets:UIEdgeInsetsMake(-(imageHeight*0.5 + spacing*0.5), titleWidth*0.5, imageHeight*0.4 + spacing*0.5, -titleWidth*0.5)];
        [self setTitleEdgeInsets:UIEdgeInsetsMake(titleHeight*0.8 + spacing*0.5, -imageWidth*0.5, -(titleHeight*0.8 + spacing*0.5), imageWidth*0.5)];
